...
// too large
shouldThrow(() => new Temporal.Instant(86400_0000_0000_000_000_001n), RangeError, /\b8640000000000000000001\b/);
// too small
shouldThrow(() => new Temporal.Instant(-86400_0000_0000_000_000_001n), RangeError, /-8640000000000000000001\b/);
// larger than maxint128
shouldThrow(() => new Temporal.Instant(1n << 129n), RangeError, /\b680564733841876926926749214863536422912\b/);
// smaller than minint128
shouldThrow(() => new Temporal.Instant(-1n << 129n), RangeError, /-680564733841876926926749214863536422912\b/);
// does not crash when bigint longer than maxint32 digits
shouldThrow(() => new Temporal.Instant(BigInt('9'.repeat(2147483647))), RangeError);
